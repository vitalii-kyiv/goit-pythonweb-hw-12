...
1. Запустить все тесты в файле:
   pytest tests/routes/test_contacts_routes.py -v

2. Запустить конкретный тест:
   pytest tests/routes/test_contacts_routes.py::test_create_contact -v

3. Запустить тесты с выводом print:
   pytest tests/routes/test_contacts_routes.py -v -s

4. Запустить тесты с остановкой на первой ошибке:
   pytest tests/routes/test_contacts_routes.py -v -x

Флаг -v для подробного вывода
Флаг -s для вывода print statements
Флаг -x для остановки на первой ошибке
"""